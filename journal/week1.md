...
## Tasks Completed
We built an image via Gitpod. Launched the micro blogging app - Cruddur on a localhost. For this we created `frontend-react-js` file and a `backend-flask` file which were connected. 
